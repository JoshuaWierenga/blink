...
// Based on https://github.com/jart/cosmopolitan/blob/9634227/libc/intrin/formatint32.c
 ...
 */
char *FormatUint32(char p[12], uint32_t x) {
  char t;
  size_t i, a, b;
  i = 0;
  do {
 ...
 * @return pointer to nul byte
 */
char *FormatInt32(char p[12], int32_t x) {
