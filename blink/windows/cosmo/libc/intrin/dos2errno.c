...
#include "blink/windows/cosmo/libc/intrin/dos2errno.internal.h"
#include "blink/windows/cosmo/libc/sock/internal.h"

// Based on https://github.com/jart/cosmopolitan/blob/9634227/libc/intrin/dos2errno.c
 ...
 * consts.sh.
 */
errno_t __dos2errno(uint32_t error) {
  int i;
  if (error) {
