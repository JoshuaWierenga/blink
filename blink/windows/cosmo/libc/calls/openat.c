...
// Based on https://github.com/jart/cosmopolitan/blob/9634227/libc/calls/openat.c
...
int openat(int dirfd, const char *file, int flags, ...) {
  ...
  if (file) {
    // TODO: Find out if windows open is good enough or should I be using cosmo's version.
