#ifndef BLINK_WIN_STAT_H_
#define BLINK_WIN_STAT_H_
...
#define _STAT_DEFINED      /* Avoid mingw trying to define stat */
...
#else
// Cannot use on windows because of a conflicting defintion for struct stat.
// Everything required for blink is already implemented above and if more
// is later required then it will likely have to use cosmo's struct stat
// defintion anyway.
#include_next <sys/stat.h>
#endif

#endif /* BLINK_WIN_STAT_H_ */
